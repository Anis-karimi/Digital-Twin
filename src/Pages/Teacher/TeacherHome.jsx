...
export const TeacherHome = () => {
  ...
  const handleTouchEnd = () => {
    ...
    // ========================================
    // LTR / RTL Swipe Direction
    // ========================================

    const shouldGoToLesson = isRTL
      ? offset > threshold // فارسی: Swipe Right
      : offset < -threshold; // انگلیسی: Swipe Left

    if (shouldGoToLesson) {
      if (firstLessonIndex !== -1) {
        setSwipeOffset(isRTL ? window.innerWidth : -window.innerWidth);
